...
jQuery(document).ready(function (a) {
    ...
    c = function (b) {
        ...
        a('#quick-press .submit input[type="submit"], #quick-press .submit input[type="reset"]').prop("disabled", !1), c = a("#quick-press").submit(function () {
            function b() {
    ...
    }, quickPressLoad(), a(".meta-box-sortables").sortable("option", "containment", "document")
});